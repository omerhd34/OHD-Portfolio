...
export const experienceList = [
 ...
 },
 {
  ...
  gpa: null,
  descriptionTr:
   "Freelance Full Stack Developer olarak e-ticaret, sağlık ve muhasebe sektörlerinde 6+ gerçek müşteri projesi geliştirdim. Next.js, React ve Node.js ile uçtan uca web uygulamaları üretirken, Cursor gibi araçlarla geliştirme süreçlerini hızlandırıyorum. iyzico ve PayTR ödeme entegrasyonları, admin panel sistemleri ve sipariş takip altyapıları dahil tam kapsamlı çözümler teslim ettim. Tüm projeler aktif olarak kullanımda.",
  descriptionEn:
   "As a freelance Full Stack Developer, I have delivered 6+ real client projects across e-commerce, healthcare, and accounting sectors. I build end-to-end web applications with Next.js, React, and Node.js, while accelerating development workflows with tools like Cursor. I have delivered full-featured solutions including iyzico and PayTR payment integrations, admin panel systems, and order tracking infrastructure. All projects are actively in use.",
  technologies: [
   "FaHtml5",
   "FaCss3Alt",
   "FaJsSquare",
