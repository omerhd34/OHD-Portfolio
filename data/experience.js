...
export const experienceList = [
 ...
 },
 {
  ...
  gpa: null,
  descriptionTr:
   "Freelance Full Stack Developer olarak e-ticaret, sağlık, muhasebe ve finans sektörlerinde 6'dan fazla gerçek müşteri projesi teslim ettim. Next.js, React ve Node.js ile uçtan uca web uygulamaları geliştirirken Prisma, REST API ve modern UI katmanlarıyla ölçeklenebilir altyapılar kuruyorum. iyzico, PayTR ve Shopier ödeme entegrasyonları, kapsamlı admin panelleri, sipariş takip sistemleri, SSR tabanlı SEO ve Google Gemini destekli finansal analiz çözümleri ürettim. Cursor ile geliştirme süreçlerini hızlandırıyor, projeleri Vercel ve cPanel üzerinde canlıya alıyorum. Teslim ettiğim tüm platformlar aktif olarak kullanılmaya devam ediyor.",
  descriptionEn:
   "As a freelance Full Stack Developer, I have delivered 6+ real client projects across e-commerce, healthcare, accounting, and finance. I build end-to-end web applications with Next.js, React, and Node.js, while designing scalable backends with Prisma, REST APIs, and modern UI layers. I have shipped full-featured solutions including iyzico, PayTR, and Shopier payment integrations, comprehensive admin panels, order tracking systems, SSR-based SEO, and Google Gemini–powered financial analysis. I accelerate delivery with Cursor and deploy to Vercel and cPanel. Every delivered platform remains actively in use.",
  technologies: [
   "FaHtml5",
   "FaCss3Alt",
   "FaJsSquare",
  ...
  achievementsTr: [
   ...
   "Cursor ile geliştirme süreçlerini hızlandırıyorum",
   "Tüm projeler Vercel ve cPanel üzerinde aktif olarak kullanımda",
   "Next.js SSR ile SEO optimizasyonu sağlayan platformlar geliştirdim",
  ],
  achievementsEn: [
   ...
   "Accelerating development workflows with Cursor",
   "All projects actively running on Vercel and cPanel",
   "Built platforms with Next.js SSR for SEO optimization",
  ],
  icon: "FaBriefcase",
 },
 {
  ...
  technologies: ["MdDomain", "FaServer", "FaCloud", "FaCpanel"],
  achievementsTr: [],
  achievementsEn: [],
  icon: "IxirhostIcon",
 },
